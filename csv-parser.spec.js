        ...
        return csv.parser('large-input-email.csv', strategy.STRATEGY_TYPE.PHONE)
            .then((resp) => {
                expect(resp[1]).toEqual([
                    ...
                    'Othilia,Baudasso,obaudassol@indiegogo.com,7554158745',
                    ...
                    'Sherman,Hounsome,shounsome16@ocn.ne.jp,1151287553',
                    ...
                    'Wiley,Lean,wlean2e@youtu.be,5244307381',
                    ...
                    'Faith,Brundill,fbrundill2q@vimeo.com,9488658084',
